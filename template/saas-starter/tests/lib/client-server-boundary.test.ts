...
const FORBIDDEN_IMPORT_RE =
  /from\s+['"](~\/db(?:\/(?:schema|enums|relations|common|index))?|~\/env|~\/lib\/(?:auth|safe-action|storage|email-service|nodemailer|organization-access|plan-limits|plans|billing|stripe)|server-only|drizzle-orm(?:\/[^'"]*)?)['"]/
