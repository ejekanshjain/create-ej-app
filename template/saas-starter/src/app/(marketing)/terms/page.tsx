...
export default function TermsPage() {
  return (
    <LegalPage title="Terms of Service">
      ...
      <LegalSection title="2. Paid Plans">
        <p>
          Paid plans renew each billing period until you cancel from the billing
          page. Cancelling keeps your plan until the period ends.
        </p>
      </LegalSection>
